...
<div class="right">
<form  method="post" id="form" action="savelcddeviceconfig" style="margin-left: 20%;" enctype="multipart/form-data">
...
<td>
<input type="text" id="devicename" name="deviceobj.Device_Name" required/> 
</td>
</tr>
<tr>
<td>
...
<td>
<select id="devicetype" name="deviceobj.Device_Type">
...
<td>
<select id="devicemode" name="deviceobj.display_mode">
</select>
</td>
</tr>
<tr>
...
<td>
<input type="number" id="address" name="deviceAdd" style="width: 190px;" required>
</td>
</tr>
...
<td>
<input type="text" id="" name="deviceobj.Device_Ip"  class="upload table-margin-left table-margin-top" />
</td></tr>

</table>
<div id="platform">
<label class="table-margin-top" name="" id="" style="color: white;">Platform:</label>
<input type="hidden" name="deviceobj.Device_Platform" id="hid">
<fieldset>
<label style="color: white;"> Select All</label> <input type="checkbox" name="pf" onclick="toggle(this);" value="ALL" ><br/>
<label style="color: white;"> 1</label><input type="checkbox" name="pf" value="1" />     
<label style="color: white;"> 2</label><input type="checkbox" name="pf" value="2"/>
<label style="color: white;"> 3</label><input type="checkbox" name="pf" value="3"/>
<label style="color: white;"> 4</label><input type="checkbox" name="pf" value="4" />
<label style="color: white;"> 5</label><input type="checkbox" name="pf" value="5"/>     
<label style="color: white;"> 6</label><input type="checkbox" name="pf" value="6" />
<label style="color: white;"> 7</label><input type="checkbox" name="pf" value="7" />
<label style="color: white;"> 8</label><input type="checkbox" name="pf" value="8" />
<label style="color: white;"> 9</label><input type="checkbox" name="pf" value="9" />     
<label style="margin-left: -6px;color: white;"> 10</label><input type="checkbox" name="pf" value="10"/>
<label style="margin-left: -9px;color: white;"> 11</label><input type="checkbox" name="pf" value="11" />
<label style="margin-left: -9px;color: white;"> 12</label><input type="checkbox" name="pf" value="12" />
...
<input type="number" name="deviceobj.cgdb_count" id="coachcount" requried/>
</div>
<div id="brige">
<label class="table-margin-top" id=""  style="color: white;">First Bridge:</label>
<select id="fbridge" name="deviceobj.firstBridge">
...
<select id="sbridge" name="deviceobj.secondBridge">
<option value="NA" >NA</option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
...
<div class="buttons" style="text-align: center;margin-right: ">
<input type="submit" class="btn orange" id="save" value="Save" style="height: 30px"/>
<button type="button" class="btn orange"  style="height: 30px" id="view">View</button>
</div> 
...
<script type="text/javascript" src="../js/jquery-2.1.4.js"></script> 
 ...
 <script type="text/javascript">
   $( document ).ready(function() {	
	  /*  var flag=<s:property value="sflag"/>;   
	   alert("flg"+flag); 
		 if(flag==1)
			{
	  alert("Device Configured Successfully");
	   ...
	   $('#view').click(function()
			   {
		   window.location.href ="lcddevicedetail";
			   });
