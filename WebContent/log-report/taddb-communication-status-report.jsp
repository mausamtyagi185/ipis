...
<title>TADB Communication Status Report</title>
...
<ul>
   ...
   <li class='active'><a href='TADBCommStatusLogReport'>TADDB Communication Status Report</a></li>
...
<div class="right" >
<br>
<form action="getTADBCommStatusLogReport" method="post">
...
<h3 style="text-align: center;"><label>TADB Communication Status Report</label></h3><hr>
...
<s:iterator value="tadbCommStatusLogList" status="list">  
<tr>
<td><s:property value="#list.index+1"/></td>
<td><s:property value="BoardName"/></td>
<td><s:property value="ConnectedTo"/></td>
