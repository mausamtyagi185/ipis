...
<title>Link Check Status Report</title>
...
<ul>
   ...
   <li class='active'><a href='LinkCheckStatusLogReport'>Link Status Report</a></li>
...
<div class="right" >
<br>
<form action="getLinkCheckStatusLogReport" method="post">
...
<h3 style="text-align: center;"><label>Link Check Status Report</label></h3><hr>
<table class="example"  class="display" cellspacing="0" width="100%" style="font-size: 12px"><thead>
<tr>
<th>S.No</th>
<th>Hub / Board Name</th>
<th>Port Number</th>
<th>Board Address</th>
<th>Hub ID</th>
<th>Communication</th>
...
<s:iterator value="linkCheckStatusLogList" status="list">  
<tr>
...
<td><s:property value="CdcID"/></td>
<td><s:property value="Communication"/></td>
<td><s:property value="Configuration"/></td>
