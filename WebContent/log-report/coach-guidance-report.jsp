...
<title>Coach Guidance Report</title>
...
<ul>
   ...
   <li class='active'><a href='coachGuidanceLogReport'>Coach Guidance Report</a></li>
...
<form action="getCGDBBoardLogReport" method="post">
...
<h3 style="text-align: center;"><label>Coach Guidance Report</label></h3><hr>
...
<s:iterator value="CGDBDisplayLogList" status="list">  
<tr>
<td><s:property value="#list.index+1"/></td>
<td><s:property value="trainNo"/></td>
<td><s:property value="defaultPlatform"/></td>
<td><s:property value="coachPositions"/></td>
