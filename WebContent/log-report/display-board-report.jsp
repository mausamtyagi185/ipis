...
<title>Display Board Report</title>
...
<ul>
   ...
   <li class='active'><a href='displayBoardLogReport'>Display Board Report</a></li>
...
<div class="right" >
<br>
<form action="getDisplayBoardLogReport" method="post">
...
<h3 style="text-align: center;"><label>Display Board Report</label></h3><hr>
...
<s:iterator value="platformDisplayLogList" status="list">  
<tr>
