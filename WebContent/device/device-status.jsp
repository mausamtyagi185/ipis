...
//--------------------show processing image--------------------
	...
	$( ".pdclink" ).click(function() { 
		$( "#pdcProcessing" ).css("display","inline-block");
        $( ".pdclink" ).addClass("not-active");
        $( ".tiblink" ).addClass("not-active");
        $( ".cgdlink" ).addClass("not-active");
        $('.tab').addClass("not-active-privilege");
	});	
	
	$( ".tiblink" ).click(function() { 
	...
	$( ".cgdlink" ).click(function() { 
		var id=this.id.split("_");
        $( "#cgdProcessing_"+id[1] ).css("display","inline-block");
        $( ".cgdlink" ).addClass("not-active");
        $( ".pdclink" ).addClass("not-active");
        $( ".tiblink" ).addClass("not-active");
        $("#headertab").addClass("not-active");
        $("#sidetab").addClass("not-active");
        $('.tab').addClass("not-active-privilege");
...
<div style="background: #111">
   ...
   <ul id="headertab" style="list-style-type: none;margin: 0;padding: 0;overflow: hidden;background-color: #335996">
         ...
         <li style=" float: left;"><a class="active tab" style="display: block;color: white;text-align: center;padding: 5px 16px;text-decoration: none;" href="deviceStatus">Status</a></li>
...
<div id='cssmenu'>
<ul id="sidetab">
   <li class='active tab'><a href='deviceStatus'>Link Status</a></li>
   <li><a class="tab" href='communicationStatus'>Communication Status</a></li>
...
<h3 style="text-align: center;"><label>PDC Link Status</label></h3><hr>
<table class="example" class="display" cellspacing="0" width="100%" style="font-size: 15px"><thead>
<tr>
<th>S.No</th><th>Device Id</th><th>Device Name</th><th>Platform No</th><th>Device Ip</th><th>CDS Port</th><th>PDC Port</th><th>Connection Status</th>
</tr>
</thead><tbody>
<s:iterator value="pdcDeviceList" status="list">  
<tr><td><s:property value="#list.index+1"/></td><td><s:property value="deviceId"/></td><td><s:property value="deviceName"/></td><td><s:property value="platformNo"/></td><td><s:property value="deviceIp"/></td><td><s:property value="cdsPort"/></td><td><s:property value="pdcPort"/></td>
<td><s:if test="%{connectionStatus==true}"><img src="../images/true.png" alt="true"> </s:if>
<s:else><img src="../images/false.png" alt="false"> </s:else></td>
<%-- <td><s:property value="connectionStatus"/></td> --%>
</tr>
</s:iterator></tbody>
</table>
<!-- <div id="buttons"> -->
<form action="GetPDCLinkAction">
<button class="btn orange pdclink" style="margin-left:45%;">Get Link</button>
<div id="pdcProcessing" style="float:right; top:780px;right:40px; left:850px; display:none; vertical-align: top; margin-top: 10px;">
...
<div style="background: rgba(0, 0, 0, 0.68);">
<h3 style="text-align: center;"><label>TIB Link Status</label></h3><hr>
<form action="GetBoardLinkAction" id="tibBoard">
<table class="example" class="display" cellspacing="0" width="100%" style="font-size: 15px"><thead>
<tr>
<th>S.No</th><th>Device Id</th><th>Device Name</th><th>Platform No</th><th>Device Ip</th><th>CDS Port</th><th>PDC Port</th><th>Connection Status</th>
</tr>
</thead><tbody>
<s:iterator value="tibDeviceList" status="list">  
<tr><td><s:property value="#list.index+1"/></td><td><s:property value="deviceId"/></td><td><s:property value="deviceName"/></td><td><s:property value="platformNo"/></td><td><s:property value="deviceIp"/></td><td><s:property value="cdsPort"/></td><td><s:property value="pdcPort"/></td>
<td><s:if test="%{connectionStatus==true}"><img src="../images/true.png" alt="true"> </s:if>
<s:else><img src="../images/false.png" alt="false"> </s:else></td>
<%-- <td><s:property value="connectionStatus"/></td> --%>
...
<!-- <div id="buttons"> -->
<button class="btn orange tiblink" style="margin-left:45%;" id="boardButton">Get Link</button>
...
<div class="coach">
<div style="background: rgba(0, 0, 0, 0.68);">
<s:iterator value="cgdList" id="coach" status="list" ><hr>
<center><label>Platform NO - <s:property value="cgdList[#list.index][0].platformNo"/></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><s:property value="cgdList[#list.index][0].cdsPort"/></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>PDC Port &nbsp;-&nbsp;<s:property value="cgdList[#list.index][0].pdcPort"/></label><hr></center> 
<div style="width: 100%; ">
<table class="display" cellspacing="0" width="100%" style="font-size: 13px">
<tr><th>Coach</th>
...
<td><s:if test="%{#device.connectionStatus==true}"><img src="../images/true.png" alt="true"> </s:if>
<s:else><img src="../images/false.png" alt="false"> </s:else></td>
<%-- <td><s:property value="#device.connectionStatus"/></td> --%>
</s:iterator>
</tr>
</table>
<!-- <div id="buttons"> -->
<a href="GetCGSLinkAction?platform=<s:property value='cgdList[#list.index][0].platformNo'/>" style="margin-left:45%;" class="btn orange cgdlink" id="cgdlink_<s:property value='#list.index'/>">Get Link</a>
<div id="cgdProcessing_<s:property value='#list.index'/>" style="float:right; top:780px;right:40px; left:850px; display:none; vertical-align: top; margin-top: 10px;">
     <img height="25px;" width="160px" src="../images/processbar.gif"/>
</div>
<!-- </div> -->
</div>
