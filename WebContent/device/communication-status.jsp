...
<div style="background: #111">
   ...
   <ul style="list-style-type: none;margin: 0;padding: 0;overflow: hidden;background-color: #335996">
         ...
         <li style=" float: left;"><a style="display: block;color: white;text-align: center;padding: 5px 16px;text-decoration: none;" class="active" href="deviceStatus">Status</a></li>
		 <li style=" float: left;"><a style="display: block;color: white;text-align: center;padding: 5px 16px;text-decoration: none;" <s:if test='%{#session["user"].display==false}'> class="not-active-privilege" </s:if>  href="deviceConfig">Display</a></li>
		  <li style=" float: left;"><a style="display: block;color: white;text-align: center;padding: 5px 16px;text-decoration: none;" <s:if test='%{#session["user"].intensity==false}'> class="not-active-privilege" </s:if> href="deviceIntensity">Intensity</a></li>
...
<div id='cssmenu'>
<ul>
   <li ><a href='deviceStatus'>Link Status</a></li>
   <li class='active'><a href='communicationStatus'>Communication Status</a></li>
...
<h3 style="text-align: center;"><label>PDC Communication Status</label></h3><hr>
<table class="example" class="display" cellspacing="0" width="100%" style="font-size: 13px"><thead>
<tr><th>S.No</th><th>Device Id</th><th>Device Name</th><th>Platform No</th><th>Device Ip</th><th>CDS Port</th><th>PDC Port</th><th>Connection Status</th><th>Last Communication Status</th></tr>  </thead>
<tbody>
<s:iterator value="pdcDeviceList" status="list">
<tr><td><s:property value="#list.index+1"/></td><td><s:property value="deviceId"/></td><td><s:property value="deviceName"/></td><td><s:property value="platformNo"/></td><td><s:property value="deviceIp"/></td><td><s:property value="cdsPort"/></td><td><s:property value="pdcPort"/></td><td style="text-align: center;"><s:if test="%{connectionStatus==true}"><img src="../images/true.png" alt="true"> </s:if>
<s:else><img src="../images/false.png" alt="false"> </s:else></td>
<%-- <td><s:property value="connectionStatus"/></td> --%>
<td><s:property value="lastCommunicationTime"/></td></tr>
</s:iterator></tbody>
</table>
<br></div>

<div style=" background: rgba(0, 0, 0, 0.68);">
<h3 style="text-align: center;"><label>TIB Communication Status</label></h3><hr>
<table class="example" class="display" cellspacing="0" width="100%" style="font-size: 13px"><thead>
<tr><th>S.No</th><th>Device Id</th><th>Device Name</th><th>Platform No</th><th>Device Ip</th><th>CDS Port</th><th>PDC Port</th><th>Connection Status</th><th>Last Communication Status</th></tr>  </thead>
<tbody>
...
<div style="width: 100%;  background: rgba(0, 0, 0, 0.68);"><br>
<center><label><label>Platform NO - <s:property value="#coach[#list.index].platformNo"/></label></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><s:property value="#coach[#list.index].cdsPort"/></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>PDC Port &nbsp;-&nbsp;<s:property value="#coach[#list.index].pdcPort"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Last Comm. Time : - <s:property value="#coach[#list.index].lastCommunicationTime"/></label></center>
...
<td>
<s:if test="%{#device.connectionStatus==true}"><img src="../images/true.png" alt="true"> </s:if>
<s:else><img src="../images/false.png" alt="false"> </s:else>
<%-- <s:property value="#device.connectionStatus"/> --%>
</td>
</s:iterator>
</tr>
</table></div>
