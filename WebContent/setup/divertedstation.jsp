...
$( document ).ready(function() {
	...
	$( "#keyboard" ).focus(function() {
	 ...
	 $('#stationList').change(function(){
		   ...
		   var formInput=$("#divertedStationForm #stationList").serialize();//alert(formInput);
		   
		   if($("#divertedStationForm #stationList").val()!=0){
		   
		   $.getJSON('getDivertedStation', formInput,function(data) { //alert(data.trainStatus.id);
			   if(data.divertedStation.id!=0){
				   $('#id').attr('value', data.divertedStation.id);
				   $('#stationCode').attr('value', data.divertedStation.stationCode);
				   $('#Engkeyboard').attr('value', data.divertedStation.stationNameEnglish);
				   $('#keyboard').attr('value', data.divertedStation.stationNameHindi);
				   $('#regkeyboard').attr('value', data.divertedStation.stationNameRegional);
				   $('#delete').attr('href', "deleteDivertedStation?id="+data.divertedStation.id);
			   }
	 ...
	 $("#save").click(function(){
		 if($('#stationCode').val()!="" && $('#Engkeyboard').val()!="" ){
		
			 if($("#id").val()==0){
				 var stationCode=$("#stationCode").val();
				 $.getJSON("checkDuplicateStationCode?stationCode="+stationCode,function(data){
					 if(data.result=="duplicate"){
						 swal('Station Code Already Exist');
						 $('#id').attr('value', "");
						 $('#stationCode').attr('value', "");
					     $('#Engkeyboard').attr('value', "");
					     $('#keyboard').attr('value', "");
					 }else{ 
						 $("#divertedStationForm").submit();
					 }
		         });     
			 } else{ 
				 $("#divertedStationForm").submit(); 
			 ...
			 swal('Please Fill out all required Fields indicated with *');
		 }
...
<li style="display: block;color: white;text-align: center;padding: 3px 20px;text-decoration: none;float: left;" ><img src="../images/arrow.PNG" style="margin-bottom: -5px">Diverted Station</li>
</ul>
</div>	
<div id="nav">
<div id='cssmenu'>
...
<li class='active'><a href='getDivertedStationList'>Diverted / Terminated Station</a></li>
...
<form id="divertedStationForm" method="post" action="saveOrUpdateDivertedStation" style="margin-left: 20%" enctype="multipart/form-data">
<%-- <table  cellspacing="10">
<tr>
<td><label>Station List</label>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><select id="stationList" name="divertedStation.id" style="width: 250px;height: 30px">
<option value="0" style="display:none;">select</option>
<option value="0">new</option>
<s:iterator value="divertedStationList" var="station">
<option value="<s:property value='#station.id'/>"><s:property value='#station.stationNameEnglish'/></option>
</s:iterator>
</select></tr></table>
<table style="margin-top: 12px">
<tr><td><label>Station Code*</label></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="text" id="stationCode" style="width: 250px;height: 30px;text-transform: uppercase;" name="divertedStation.stationCode" required></td></tr></table>
<table style="margin-top: 12px">
<tr><td><label>Station Name Eng*</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input id="Engkeyboard" name="divertedStation.stationNameEnglish" type="text" class="ui-keyboard-input form-control input-sm ui-keyboard-input-current" aria-haspopup="true" role="textbox" style="width: 250px" required>
</td></tr></table>
<table style="margin-top: 12px"><tr><td><label>Station Name Hindi</label>&nbsp;&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td> <input type="text" name="divertedStation.stationNameHindi" id="keyboard" style="width: 250px" height="45px"/></td></tr>
<table style="margin-top: 12px"><tr><td><label>Station Name Regional</label>&nbsp;&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td> <input type="text" name="divertedStation.stationNameRegional" id="regkeyboard" style="width: 250px" height="45px"/></td></tr>

</table>
<table style="margin-top: 12px"><tr><td><label>Upload Wave File</label></td><td>&nbsp;&nbsp;&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td> <input type="file" id="waveFile" name="divertedStation.fileUpload.file" class="upload" style="margin-left: 15px"/></td></tr>
</table> --%>
<table style="margin-top: 63px;">
<tr>
<td><label>Station List</label>
</td>
<td>
<select id="stationList" class="table-margin-left" name="divertedStation.id" style="width: 250px;height: 30px;">
<option value="0" style="display:none;">select</option>
<option value="0">new</option>
<s:iterator value="divertedStationList" var="station">
<option value="<s:property value='#station.id'/>"><s:property value='#station.stationNameEnglish'/></option>
...
<tr>
<td>
<label class="table-margin-top">Station Code*</label>
</td>
<td>
<input type="text" id="stationCode" class="table-margin-left table-margin-top" style="width: 250px;height: 30px;text-transform: uppercase;" name="divertedStation.stationCode" required>
</td>
</tr>

<tr>
<td>
<label class="table-margin-top">Station Name Eng*</label>
</td>
<td>
<input id="Engkeyboard" name="divertedStation.stationNameEnglish" type="text" class="ui-keyboard-input form-control input-sm ui-keyboard-input-current table-margin-left table-margin-top" aria-haspopup="true" role="textbox" style="width: 250px" required>
</td>
</tr>

<tr>
<td>
<label class="table-margin-top">Station Name Hindi</label>
</td>
<td>
<input type="text" name="divertedStation.stationNameHindi" class="table-margin-left table-margin-top" id="keyboard" style="width: 250px; height:30px"/>
</td></tr>

<tr>
<td>
<label class="table-margin-top">Station Name Regional</label>
</td>
<td>
 <input type="text" name="divertedStation.stationNameRegional" class="table-margin-left table-margin-top" id="regkeyboard" style="width: 250px; height:30px"/>
</td></tr>

<tr>
<td>
<label class="table-margin-top">Upload Wave File</label>
</td>
<td>
<input type="file" id="waveFile" name="divertedStation.fileUpload.file" class="upload table-margin-left table-margin-top" />
</td></tr>
...
<a href="#" class="btn orange" id="save">Save</a>
<a href="#" class="btn purple" id="delete">delete</a>
</div> 
